...
Imports Packet = TheGarbage.TheGarbage.Network.Packet.Packet
Imports TheGarbage.TheGarbage.Network.Packet

Namespace TheGarbage.Network.PacketMon

    Public Class Monitor
        Public Delegate Sub NewPacketEventHandler(ByVal m As Monitor, ByVal p As TheGarbage.Network.Packet.Packet)
        ...
        Public Sub [Start]()
            If m_Monitor Is Nothing Then
                Try
                    m_Monitor = New Socket(AddressFamily.InterNetwork, SocketType.Raw, ProtocolType.Tcp)
            ...
            Try
                ...
                Try
                    If Not m_Monitor Is Nothing Then
                        ...
                        OnNewPacket(New TheGarbage.Network.Packet.Packet(pkt))
                    End If
                Catch
        ...
        Protected Sub OnNewPacket(ByVal p As TheGarbage.Network.Packet.Packet)
