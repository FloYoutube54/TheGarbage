...
Class Interceptor
    ...
    Private ServerRecvEvent As Sniffer.RecieveDG
    Private ClientRecvEvent As Sniffer.RecieveDG
    Private ConnectEvent As Sniffer.ConnectionDG
    Private DisconnectEvent As Sniffer.ConnectionDG
    ...
    Sub New(ByVal local As IPEndPoint, ByVal remote As IPEndPoint,
            ByVal serverRecv As Sniffer.RecieveDG,
            ByVal clientRecv As Sniffer.RecieveDG,
            ByVal connect As Sniffer.ConnectionDG,
            ByVal disconnect As Sniffer.ConnectionDG)
